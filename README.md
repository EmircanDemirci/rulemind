...
- **Sigma to Splunk**: Sigma kurallarını SPL sorgularına dönüştürme
- **GitHub Entegrasyonu**: Sigma kurallarını otomatik olarak çekme ve veritabanına kaydetme
...
- [ ] Machine Learning tabanlı otomatik kural önerisi
- [ ] SIEM platformları için direct export
- [ ] Real-time threat hunting desteği
...
Bu proje siber güvenlik toplumu için geliştirilmiştir. Amacımız, güvenlik analistlerinin iş yükünü azaltmak ve daha etkili detection rule'ları oluşturmalarına yardımcı olmaktır.
